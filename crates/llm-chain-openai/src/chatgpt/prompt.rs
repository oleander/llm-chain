use async_openai::types::{
  ChatCompletionRequestAssistantMessageArgs, ChatCompletionRequestFunctionMessageArgs, ChatCompletionRequestMessage,
...
pub fn create_chat_completion_request(
  model: ModelOpt, prompt: &Prompt, is_streaming: bool,
